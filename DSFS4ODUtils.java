...
public class DSFS4ODUtils {
    ...
    public static String dirPath= "./new_test/";
...
//    private static double timeofTesting = 0;
    ...
    {
          String str = "./data/UCI/temp/"; //path of an ARFF data set or a folder that contains ARFF data sets
    ...
    public static void featureselectionOptions(boolean flag) throws Exception {
        ...
        if(flag) {
            ...
            trainInstances = readDataSet(dataFilename);
            testInstances = readDataSet(dataFilename);
//            System.out.println(trainInstances.numInstances());
...
//        FSIRC
        SubgraphDiscovery2 dsd = new SubgraphDiscovery2();
        
        String savIDs = dsd.denseSubgraphDiscovery(cpList, trainInstances, trainInstances.numInstances());
//        long end = System.currentTimeMillis();
//        System.out.println("The removed features' ID(s):"+savIDs);
        System.out.println("(including classID)The saved features' ID(s):"+savIDs);
        dsd.featureSelection(trainInstances, savIDs, dirPath, dataSetName);
